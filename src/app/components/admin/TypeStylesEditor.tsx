...
export function TypeStylesEditor({
  styles,
  colors,
  customFamilies,
  onChange,
  usageLabelFor,
}: TypeStylesEditorProps) {
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        update(s.key, {
                          fontSizePx: e.target.value ? Number(e.target.value) : undefined,
                        })
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        update(s.key, {
                          letterSpacingPx: e.target.value ? Number(e.target.value) : undefined,
                        })
                      }
                    />
                  </div>
